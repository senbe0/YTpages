    ...
    return (
        <div className="main">
          ...
          <div>
            ...
            <strong>※This is currently under TEST Operation.</strong><br/>
            <strong>※現在全ての配信がリストされていません。</strong><br/>
            <strong>※Currently NOT all streaming are listed due to reboot. </strong><br/>
            <Color_lines />
            <LineCharts />
            <div className="ad-baner">
              <Ad_ntt />
